                ...
                <div className="w-full max-w-sm">
                    ...
                    <form onSubmit={handleSubmit}>
                            ...
                            <div>
                                <label htmlFor="email" className="mb-2 block text-sm font-medium text-gray-300">Email</label>
                                    <input 
                                        ...
                                        required 
                                        disabled={isLoading}
                                        className="w-full rounded-lg border border-gray-700 dark:bg-black px-4 py-3 text-white placeholder-gray-500 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-yellow-200 disabled:opacity-50"/>
                            </div>
                        <div>
                        ...
                        <button 
                            type="submit" 
                            disabled={isLoading}
                            className="w-full rounded-lg bg-yellow-500 px-5 py-3 text-base font-bold text-gray-900 hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                    ...
                    <div className="flex flex-col space-y-4">
                        <button type="button" className="flex w-full items-center justify-center rounded-lg border border-gray-700 dark:bg-black px-5 py-3 text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500">
                            <FcGoogle className='mr-3'/> Entrar com Google
                        </button>
                        <button type="button" className="flex w-full items-center justify-center rounded-lg border border-gray-700 dark:bg-black px-5 py-3 text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500">
                            <FaFacebook className='mr-3'/>Entrar com Facebook
                        </button>
                    </div>
